document.addEventListener("DOMContentLoaded", () => {
    ...
    for (let i = 0;  i < squares.length ; i++) {
        ...
        (function (index) {
            ...
            squares[i].onclick = function () {
                // If the square below you is taken, you can go top of it. 
                if (squares[index + 7].classList.contains("taken")) {
                    ...
                    // If the square below your square is not taken, you can't go there 
                } else {
                    alert("Can't go here")
                }
            }
    ...
    function checkBoard() {
        ...
        // Now take  the 4 values in each winning arrays and plug them into squares
        for (let i = 0; i < winningArrays.length; i++) {
            ...
            // Now check those arrays if they all have the class of player-one
            ...
            // Now check if they have the class of player two
    ...
    squares.forEach(el => {
        el.addEventListener("click", checkBoard)
    })
