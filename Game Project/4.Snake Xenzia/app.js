document.addEventListener("DOMContentLoaded", ()=>{
    ...
    let currentSnake = [2,1,0] // So the divs in our grid being 2(or the head), and 0 being the end(tail), with 1 being the body. 
    let direction = 1
    let score = 0
    let speed = 0.9
    let intervalTime = 0
    ...
    // Function that deals with all the outcomes of the snake. 
        ...
        squares[tail].classList.remove("snake") // Removes the class snake from the tail. 
    ...
    function control(e) {
        ...
        if (e.keyCode === 39) {
            ...
            direction = +width // If we press down the snake will appear ten divs from where you are appearing to move down.
        }
    }
